...
## For simulating forms using POST example we will make forms parameters and 
## send it to the server just like as a normal web page 
r = requests.post('http://httpbin.org/post', data={'name':'packt'})  # senging get requests for headers
